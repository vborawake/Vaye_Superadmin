...
const localizationPopup = document.getElementById('localization_popup');
const verificationPopup = document.getElementById('verification_popup');
const authenticationPopup = document.getElementById('authentication_popup');
...
async function showPopup(e, action) {
    if (action === 'localization_open') await openPopup(localizationPopup);
    else if (action === 'localization_close') await closePopup(localizationPopup);
    else if (action === 'verification_close') await closePopup(verificationPopup);
    else if (action === 'verification_open') await openPopup(verificationPopup);
    else if (action === 'authentication_open') await openPopup(authenticationPopup);
    else if (action === 'authentication_close') await closePopup(authenticationPopup);
}
